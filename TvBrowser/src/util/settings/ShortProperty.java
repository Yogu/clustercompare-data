 ...
 *
 * CVS information:
 *     $Date: 2008-04-19 20:35:30 +0200 (Sat, 19 Apr 2008) $
 *   $Author: ds10 $
 * $Revision: 4537 $
 */
...
public class ShortProperty extends Property {
   ...
   */
  public ShortProperty(PropertyManager manager, String key,
    short defaultValue)
  {
    super(manager, key);
  ...
  public short getShort() {
    if (! mIsCacheFilled) {
      ...
      if (asString == null) {
        ...
        try {
          mCachedValue = Short.parseShort(asString);
        }
        catch (Exception exc) {
          mCachedValue = mDefaultValue;
        }
  ...
  public void setShort(short value) {
    if (value == mDefaultValue) {
      ...
      setProperty(Short.toString(value));
    }
